...
public class HistoryController extends FragmentCallbacks.Observer {
    ...
    private MainScreenSelectedDateStorage mainScreenSelectedDateStorage;
    ...
    public HistoryController(
            ...
            MainScreenSelectedDateStorage mainScreenSelectedDateStorage) {
        ...
        this.mainScreenSelectedDateStorage = mainScreenSelectedDateStorage;
    }
    ...
    public void onFragmentViewCreated(View fragmentView, Bundle savedInstanceState) {
        ...
        initCard();
        if (!mainScreenSelectedDateStorage.hasSelectedDate()) {
            mainScreenSelectedDateStorage.setSelectedDate(timeProvider.now().toLocalDate());
        }
        switchToDate(mainScreenSelectedDateStorage.getSelectedDate(), fragmentView);
    ...
    private void switchToDate(LocalDate date, View fragmentView) {
        mainScreenSelectedDateStorage.setSelectedDate(date);
        ...
        calendarButton.setOnClickListener(v -> {
            ...
            if (mainScreenSelectedDateStorage.hasSelectedDate()) {
                datePickerFragment = DatePickerFragment.showDialog(
                        ...
                        mainScreenSelectedDateStorage.getSelectedDate());
            } else {
    ...
    private void initReturnToCurrentDateButton(View fragmentView) {
        ...
        LocalDate selectedDate = mainScreenSelectedDateStorage.getSelectedDate();
