 ...
 */
@ActivityScope
public class MainScreenSelectedDateStorage implements ActivityCallbacks.Observer {
    private static final String EXTRA_SELECTED_DATE = "EXTRA_SELECTED_DATE";
    @Nullable
    private LocalDate selectedDate;

    @Inject
    public MainScreenSelectedDateStorage(ActivityCallbacks activityCallbacks) {
