...
public class DatabaseWorker {
    ...
    public void saveFoodstuff(Context context, Foodstuff foodstuff) {
    ...
    public void editFoodstuff(Context context, long editedFoodstuffId, Foodstuff newFoodstuff) {
        FoodstuffsDbHelper dbHelper = new FoodstuffsDbHelper(context);
        SQLiteDatabase database = dbHelper.openDatabase(SQLiteDatabase.OPEN_READWRITE);
    ...
    public void deleteFoodstuff(Context context, long foodstuffsId) {
        FoodstuffsDbHelper dbHelper = new FoodstuffsDbHelper(context);
        SQLiteDatabase database = dbHelper.openDatabase(SQLiteDatabase.OPEN_READWRITE);
        database.delete(TABLE_NAME, "id = ?", new String[]{String.valueOf(foodstuffsId)});
    }

    public ArrayList<Foodstuff> getAllFoodstuffsFromDb(Context context) {
        FoodstuffsDbHelper dbHelper = new FoodstuffsDbHelper(context);
