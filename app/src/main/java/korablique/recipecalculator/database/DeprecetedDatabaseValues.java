...
public class DeprecetedDatabaseValues {
    ...
    public static final String GOAL_MAINTAINING_CURRENT_WEIGHT = "maintaining_current_weight"; // TODO: использовать значение вместо ID
    public static final String GOAL_MASS_GATHERING = "mass_gathering"; // TODO: использовать значение вместо ID

    public static final String GENDER_MALE = "male"; // TODO: использовать значение вместо ID
    public static final String GENDER_FEMALE = "female"; // TODO: использовать значение вместо ID
    ...
    public static final String FORMULA_HARRIS_BENEDICT = "harris_benedict"; // TODO: использовать значение вместо ID
    public static final String FORMULA_MIFFLIN_JEOR = "mifflin_jeor"; // TODO: использовать значение вместо ID
