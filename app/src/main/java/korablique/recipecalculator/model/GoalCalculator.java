...
public class GoalCalculator {
    ...
    public static int calculateProgressPercentage(float currentWeight, float firstWeight, float targetWeight) {
        ...
        // (1 итерация)
        float coefficient = 1 - (currentWeight - targetWeight) / (firstWeight - targetWeight);
