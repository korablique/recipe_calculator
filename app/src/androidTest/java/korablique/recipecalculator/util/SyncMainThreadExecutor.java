 ...
 * <br>
 * - Если объект был использован ИЗ ГЛАВНОГО потока, то переданный Runnable НЕ БУДЕТ выполне синхронно -
 ...
 * <br>
 * Раньше тестовые экзекьюторы не следовали общему андродскому контракту - выполняли задачи
